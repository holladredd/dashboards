...
const Sidebar = () => {
  return (
   <Box sx={{width:'95%', padding:'0px', height:'fit', backgroundColor:'whitesmoke'}}>
...
>
  <Box sx={{ backgroundColor:'slateblue', padding:'5px', width:'100%', height:'25vh', position:'relative', opacity:'90%' }}>
    <Box sx={{width:'70%'}}>
...
<Grid item xs={4} >
<Box  className="scale-in-center" sx={{width:'100%', padding:'5px',  height:'fit',backgroundColor:'white', borderRadius:'20px'}}>
...
<Box  className="scale-in-center" sx={{width:'100%', padding:'5px',  height:'fit',backgroundColor:'white', marginTop:'5px', borderRadius:'20px'}}
>
<Box sx={{justifyContent:'space-between'}}
>
